...
label_bienvenida = tk.Label(ventana, text="Selecciona un proyecto", font=("Arial", 16, "bold"), bg="#3C3C3C", fg="white")
label_bienvenida.pack(pady=20)

frame_boton = tk.Frame(ventana, bg="#3C3C3C")
...
copyright_label = tk.Label(ventana, text="© 2024 PROYECTO X Code. Todos los derechos reservados", font=("Arial", 10), bg="#3C3C3C", fg="white")
