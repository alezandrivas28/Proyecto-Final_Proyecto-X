...
class Ventas(tk.Frame):
    ...
    def widgets(self):
        frame1 = tk.Frame(self, bg="#66cc66", highlightbackground="green", highlightthickness=3)
        frame1.pack()
        frame1.place(x=0 , y=0, width=1100, height=100)

        titulo = tk.Label(self, text="VENTAS", bg="#66cc66", font="sans 30 bold", anchor="center")
        titulo.pack()
        titulo.place(x=5, y=0, width=1090, height=90)

        frame2 = tk.Frame(self, bg="#66b366", highlightbackground="green", highlightthickness=3)
        frame2.place(x=0, y=100, width=1100, height=550)

        lblframe = LabelFrame(frame2, text="Información de la venta", bg="#66b366", font="sans 16 bold")
        lblframe.place(x=10, y=10, width=1060, height=80)

        label_numero_factura = tk.Label(lblframe, text="Número de \nfactura", bg="#66b366", font="sans 12 bold")
        ...
        label_nombre = tk.Label(lblframe,text="Productos: ", bg="#66b366", font="sans 12 bold")
        ...
        label_valor = tk.Label(lblframe, text="Precio: ", bg="#66b366", font="sans 12 bold")
        ...
        label_cantidad = tk.Label(lblframe, text="Cantidad: ", bg="#66b366", font="sans 12 bold")
        ...
        treFrame = tk.Frame(frame2, bg="#66b366")
        ...
        lblframe1 = LabelFrame(frame2, text="Opciones", bg="#66b366", font="sans 12 bold")
        ...
        self.label_suma_total = tk.Label(frame2, text="Total a pagar: Q 0", bg="#66b366", font="sans 25 bold")
    ...
    def cargar_productos(self):
        try:
            ...
            if not productos:
                print("No se encontraron productos en base de datos")
            conn.close()
    ...
    def actualizar_total(self):
        ...
        for child in self.tree.get_children():
            ...
            total += subtotal
        self.label_suma_total.config(text=f"Total a pagar: Q {total:.2f}")
    ...
    def abrir_ventana_pago(self):
        ...
        ventana_pago.config(bg="#66b366")
        ventana_pago.resizable(False, False)

        label_total = tk.Label(ventana_pago, bg="#66b366", text=f"Total a pagar: Q {self.obtener_total():.2f}", font="sans 18 bold")
        label_total.place(x=70, y=20)

        label_cantidad_pagada = tk.Label(ventana_pago, bg="#66b366", text="Cantidad pagada", font="sans 14 bold")
        ...
        label_cambio = tk.Label(ventana_pago, bg="#66b366", text="", font="sans 14 bold")
        ...
        def calcular_cambio():
            try:
                ...
                if cambio < 0:
                    ...
                    return
                label_cambio.config(text=f"Vuelto: Q {cambio:.0f}")
            except ValueError:
    ...
    def pagar(self, ventana_pago, entry_cantidad_pagada, label_cambio):
        try:
            ...
            try:
                ...
                self.label_suma_total.config(text="Total a pagar: Q 0")
    ...
    def abrir_ventana_factura(self):
        ...
        ventana_facturas.config(bg="#66b366") 
        ventana_facturas.resizable(False,False)

        factura = Label(ventana_facturas, bg="#66b366", text="Facturas registradas", font="sans 36 bold")
        factura.place(x=150, y=15)

        treFrame = tk.Frame(ventana_facturas, bg="#66b366")
