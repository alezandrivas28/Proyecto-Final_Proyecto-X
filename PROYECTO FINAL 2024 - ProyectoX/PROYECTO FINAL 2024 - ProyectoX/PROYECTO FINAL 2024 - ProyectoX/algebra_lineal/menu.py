...
class MenuPrincipal(tk.Frame):
    ...
    def widgets(self):
        ...
        copyright_label = tk.Label(frame, text="© 2024 PaluZero Code. Todos los derechos reservados", font="sans 10 bold", bg="#000000", fg="white")
...
class MultiplicacionMatricesApp(tk.Frame):
    ...
    def widgets(self):
        ...
        titulo = tk.Label(frame1, text="Calculadora de Multiplicación de Matrices", font=("Arial", 18, "bold"), bg="#000000", fg="white")
...
class InversaMatrizApp(tk.Frame):
    ...
    def widgets(self):
        ...
        titulo = tk.Label(frame1, text="Calculadora de Inversa de Matriz", font=("Arial", 18, "bold"), bg="#000000", fg="white")
        ...
        copyright_label = tk.Label(frame1, text="© 2024 Pal Code. Todos los derechos reservados", font=("Arial", 10), bg="#000000", fg="white")
        copyright_label.place(x=250, y=570)
...
class SistemaEcuacionesApp(tk.Frame):
    ...
    def widgets(self):
        ...
        titulo = tk.Label(frame1, text="Solución de Sistema de Ecuaciones", font=("Arial", 18, "bold"), bg="#000000", fg="white")
        titulo.place(x=250, y=20)
        ...
        copyright_label = tk.Label(frame1, text="© 2024 Proyecto_X Code. Todos los derechos reservados", font=("Arial", 10), bg="#000000", fg="white")
        copyright_label.place(x=250, y=570)
